...
class EURJPYStrategy:
    ...
    def _get_news_sentiment(self, current_datetime: datetime.datetime) -> str:
        ...
        try:
            ...
            params = {
                "currencypair": "EUR-JPY", # Updated for EUR/JPY
                "items": 10,
                "date": "today",
                "token": token,
            }
            ...
            bull_kw = ["yen weak", "eurjpy rises", "risk-on", "bullish", "ecb hawkish", "boj dovish"] # Updated for EUR/JPY
            bear_kw = ["yen strong", "eurjpy falls", "risk-off", "bearish", "ecb dovish", "boj hawkish"] # Updated for EUR/JPY
    ...
    def _update_zones_upto(self, upto_idx: int) -> None:
        ...
        if self.ema_periods:
            ...
            for period in self.ema_periods:
                ...
                if latest_zone:
                    if latest_zone.get('type') == 'demand': # Bullish bias
                    ...
                    elif latest_zone.get('type') == 'supply': # Bearish bias
                        if current_price > current_ema:
        ...
        if self.enable_news_sentiment_filter:
            ...
            if latest_zone:
                if latest_zone.get('type') == 'demand' and news_sentiment == "Bearish":
                ...
                if latest_zone.get('type') == 'supply' and news_sentiment == "Bullish":
