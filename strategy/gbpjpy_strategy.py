...
class GBPJPYStrategy:
    ...
    def _get_news_sentiment(self, current_datetime: datetime.datetime) -> str:
        ...
        try:
            ...
            params = {
                "currencypair": "GBP-JPY", # Updated for GBP/JPY
                "items": 10,
                "date": "today",
                "token": token,
            }
            ...
            bull_kw = ["yen weak", "gbpjpy rises", "risk-on", "bullish", "boe hawkish", "boj dovish"] # Updated for GBP/JPY
            bear_kw = ["yen strong", "gbpjpy falls", "risk-off", "bearish", "boe dovish", "boj hawkish"] # Updated for GBP/JPY
